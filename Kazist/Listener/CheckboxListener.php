...
class CheckboxListener implements EventSubscriberInterface {

    public $container = '';

    public function onCheckboxValidation(InputEvent $event) {
    ...
    public static function getSubscribedEvents() {
        return array('input.checkbox.validation' => 'onCheckboxValidation');
    }
